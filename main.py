...
class Mind:
    def __init__(self,
                 ...
                 joy: int,
                 anger: int):
        # ИСПРАВИТЬ: на диаграмме это атрибут класса, не экземпляра
